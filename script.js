// To tylko prank nie wirus kolego aha ok
...
const SEARCHES = [
  'jak obciąć stulejkę domowym sposobem',
  'jak smakuje sperma',
  'jak wyleczyć gulajkę na gnoju',
  'gdzie najtańsza aborcja',
  'czy człowiek może zapłodnić chomika'
]

const PHRASES = [
    'ct u cb bo u mn spk',
    'aha spoko nie wnikam',
    'masz pozdrowienia od pumy',
    'czarny medyk',
    'aok to pilne',
    'xddddddddddd',
    'patiro to knur',
    'aha16 aha11 aha51 aha100 aha2 aha'
]
